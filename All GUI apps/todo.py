...
import repackage
repackage.up()
from Notifications.Notification import Item_From_TodoList_Added_In_Done_File
import time
...
class Ui_To_Do_List(object):
                ...
                def add_item(self):
                        ...
                        file=open('/home/atharva/Downloads/Jarvis/DataBase/todo_store.txt','a')
                ...
                def delete_selected(self):
                        ...
                        with open('/home/atharva/Downloads/Jarvis/DataBase/todo_store.txt', 'r') as fr:
                                lines = fr.readlines()
                        ptr = 1
                        with open('/home/atharva/Downloads/Jarvis/DataBase/todo_store.txt', 'w') as fw:
                                for line in lines:
                ...
                def Done(self):
                        ...
                        clicked1 = clicked+1
                        self.listWidget.takeItem(clicked)
                        file=open('/home/atharva/Downloads/Jarvis/DataBase/done.txt','a')
                        t = time.strftime("%I:%M %p")
                        current_date=date.today()
