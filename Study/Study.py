...
def MWR():
    os.system("tree /home/atharva/Downloads/All_study/MWR")
    print("Enter which unit you would like to study : ")
    n = input()
    n = n.lower()
    if n == "unit 1" or n =="chapter 1" or n =="first unit" or n == "unit first":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_1/*.pdf; do open "${file}"; done')
        sleep(5)

    elif n == "unit 2" or n =="chapter 2" or n =="second unit" or n == "unit second":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_2/*.pdf; do open "${file}"; done')
        sleep(5)

    elif n == "unit 3" or n =="chapter 3" or n =="third unit" or n == "unit third":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_3/*.pdf; do open "${file}"; done')
        sleep(5)

    elif n == "unit 4" or n =="chapter 4" or n =="fourth unit" or n == "unit fourth":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_4/*.pdf; do open "${file}"; done')
        sleep(5)

    elif n == "unit 5" or n =="chapter 5" or n =="fifth unit" or n == "unit fifth":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_5/*.pdf; do open "${file}"; done')
        sleep(5)

    elif n == "unit 6" or n =="chapter 6" or n =="sixth unit" or n == "unit sixth":
        os.system('for file in //home/atharva/Downloads/All_study/MWR/Unit_6/*.pdf; do open "${file}"; done')
        sleep(5)
...
def Study():
    ...
    s = input()
    s = s.lower()
    if s == "ave" or s == "audio video engineering":
        unit = AVE()
        f.write(f"On {date1} You studied {s.upper()} {unit}\n")

    elif s == "csm" or s == "control system":
        unit = CSM()
        f.write(f"On {date1} You studied {s.upper()} {unit}\n")

    elif s == "foc" or s == "fibre optic":
        unit = FOC()
        f.write(f"On {date1} You studied {s.upper()} {unit}\n")
    ...
    elif s == "ems" or s == "embedded system":
        unit = EMS()
        f.write(f"On {date1} You studied {s.upper()} {unit}\n")
...
def Yestarday():
    ...
    t = PrettyTable(['Topic'])
    for line in Lines:
        a = [line[3:13],line[26:36]]
        b.append(a)
    for i, j in zip(range(len(b)), range(len(b))):
        if b[i][0] == yesterday[0:10]:
            Unit = b[i][1]
            print(f"You were doing {Unit}")
...
def Remember():
    ...
    for line in Lines:
        a = [line[3:13],line[26:36]]
        b.append(a)
    t = PrettyTable(['Date', 'Subject'])
    for i in range(len(b)):
        t.add_row([b[i][0], b[i][1]])
    print(t)
...
# def FOC_5():
#     os.system('for file in //home/atharva/Downloads/All_study/FOC/Unit_5_6/*.pdf; do open "${file}"; done')
